...
public class LogCatFilterTest extends TestCase {
  ...
  public void testFilterByPid() {
    ...
    LogCatMessage msg = new LogCatMessage(LogLevel.VERBOSE, "123", "", "", "", "", "");
    assertEquals(true, filter.matches(msg));

    /* don't show message with pid not matching filter */
    msg = new LogCatMessage(LogLevel.VERBOSE, "12", "", "", "", "", "");
    assertEquals(false, filter.matches(msg));
  }
  ...
  public void testFilterByAppNameRegex() {
    ...
    /* show message with pid matching filter */
    LogCatMessage msg = new LogCatMessage(LogLevel.VERBOSE, "", "", "dalvikvm1", "", "", "");
    assertEquals(true, filter.matches(msg));

    /* don't show message with pid not matching filter */
    msg = new LogCatMessage(LogLevel.VERBOSE, "", "", "system", "", "", "");
    assertEquals(false, filter.matches(msg));
  }
  ...
  public void testFilterByTagRegex() {
    ...
    LogCatMessage msg = new LogCatMessage(LogLevel.VERBOSE, "", "", "", "tag123", "", "");
    assertEquals(true, filter.matches(msg));

    msg = new LogCatMessage(LogLevel.VERBOSE, "", "", "", "ta123", "", "");
    assertEquals(false, filter.matches(msg));
  }
  ...
  public void testFilterByTextRegex() {
    ...
    LogCatMessage msg = new LogCatMessage(LogLevel.VERBOSE, "", "", "", "", "", "text123");
    assertEquals(true, filter.matches(msg));

    msg = new LogCatMessage(LogLevel.VERBOSE, "", "", "", "", "", "te123");
    assertEquals(false, filter.matches(msg));
  }
  ...
  public void testCaseSensitivity() {
    LogCatMessage msg = new LogCatMessage(LogLevel.VERBOSE, "", "", "", "", "", "Sample message");
