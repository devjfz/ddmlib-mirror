...
/** Unit tests for {@link com.android.ddmlib.logcat.LogCatMessageParser}. */
public final class LogCatMessageParserTest extends TestCase {
   ...
   * }</pre>
   *
   * Note: On Android 2.3, Log.wtf doesn't really generate the message. It only produces the message
   * header, but swallows the message tag. This string has been modified to include the message.
   */
