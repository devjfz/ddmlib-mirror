...
public class EventContainer {
  ...
  /**
   * Comparison method for {@link EventContainer#testValue(int, Object,
  ...
  public static enum EventValueType {
    ...
    /**
     * Returns a {@link EventValueType} from an integer value, or <code>null</code> if no match was
     * found.
     *
    ...
    /**
     * Returns a storage string for an {@link Object} of type supported by {@link EventValueType}.
     *
     * <p>Strings created by this method can be reloaded with {@link
     * #getObjectFromStorageString(String)}.
     *
     * <p>NOTE: for now, only {@link #STRING}, {@link #INT}, and {@link #LONG} are supported.
     *
    ...
    /**
     * Creates an {@link Object} from a storage string created with {@link
   ...
   *
   * @param valueIndex the index of the value. If the data is not a list, this is ignored.
   * @throws InvalidTypeException if the data type is not {@link EventValueType#INT}, {@link
   *     EventValueType#LONG}, {@link EventValueType#LIST}, or if the item in the list at index
   *     <code>valueIndex</code> is not of type {@link EventValueType#INT} or {@link
   *     EventValueType#LONG}.
   * @see #getType()
   */
   ...
   * @param valueIndex the index of the value. If the data is not a list, this is ignored.
   * @throws InvalidTypeException if the data type is not {@link EventValueType#INT}, {@link
   *     EventValueType#LONG}, {@link EventValueType#STRING}, {@link EventValueType#LIST}, or if the
   *     item in the list at index <code>valueIndex</code> is not of type {@link
   *     EventValueType#INT}, {@link EventValueType#LONG}, or {@link EventValueType#STRING}
   * @see #getType()
   */
