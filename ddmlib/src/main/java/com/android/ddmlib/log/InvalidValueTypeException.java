...
/**
 * Exception thrown when associating an {@link EventValueType} with an incompatible {@link
 * ValueType}.
 */
public final class InvalidValueTypeException extends Exception {
   ...
   * (cause==null ? null : cause.toString())</code> (which typically contains the class and detail
   * message of cause).
   *
