...
abstract class ChunkHandler {
   ...
   */
  abstract void handleChunk(Client client, int type, ByteBuffer data, boolean isReply, int msgId);
   ...
   *
   * <p>This is here because multiple chunk handlers can make use of it, and there's nowhere better
   * to put it.
   */
  ...
  /**
   * Allocate a ByteBuffer with enough space to hold the JDWP packet header and one chunk header in
   * addition to the demands of the chunk being created.
   *
