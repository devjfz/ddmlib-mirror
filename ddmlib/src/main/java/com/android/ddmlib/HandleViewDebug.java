...
public final class HandleViewDebug extends ChunkHandler {
  ...
  public static void captureLayers(
      @NonNull Client client, @NonNull String viewRoot, @NonNull ViewDumpHandler handler)
      throws IOException {
  ...
  public static void invalidateView(
      @NonNull Client client, @NonNull String viewRoot, @NonNull String view) throws IOException {
  ...
  public static void dumpDisplayList(
      @NonNull Client client, @NonNull String viewRoot, @NonNull String view) throws IOException {
    sendViewOpPacket(client, VUOP_DUMP_DISPLAYLIST, viewRoot, view, null, sViewOpNullChunkHandler);
  }
