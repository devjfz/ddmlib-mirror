...
final class HandleThread extends ChunkHandler {
  ...
  public void clientReady(Client client) throws IOException {
    ...
    if (client.isThreadUpdateEnabled()) sendTHEN(client, true);
  }
      ...
      new Thread("Thread Status Req") {
        ...
        public void run() {
          ...
          try {
            ...
            Log.d(
                "ddms",
                "Unable to request thread updates from " + client + ": " + ioe.getMessage());
          } finally {
