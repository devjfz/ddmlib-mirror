...
public interface IShellEnabledDevice {
   ...
   *
   * <p>For commands like log output, a <var>maxTimeToOutputResponse</var> value of 0, meaning that
   * the method will never throw and will block until the receiver's {@link
