...
public final class DdmPreferences {
   ...
   *
   * <p>If <code>true</code>, the {@link ClientData} will automatically be updated with the VM heap
   * information whenever a GC happens.
   *
   * <p>This change takes effect right away, for newly created {@link Client} objects.
   */
  ...
  /**
   * Returns the debug port used by the first {@link Client}. Following clients, will use the next
   * port.
   */
   ...
   *
   * <p>Once a port is used, the next Client will use port + 1. Quitting applications will release
   * their debug port, and new clients will be able to reuse them.
   *
