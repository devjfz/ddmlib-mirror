...
public final class HeapSegment implements Comparable<HeapSegment> {
  ...
  public static class HeapSegmentElement implements Comparable<HeapSegmentElement> {
     ...
     * that follows, typically because an element is too large to be described by a single element.
     */
     ...
     * @throws BufferUnderflowException if there is not a whole entry following the current position
     *     of hpsgData.
