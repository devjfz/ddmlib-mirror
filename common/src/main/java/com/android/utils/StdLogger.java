...
public class StdLogger implements ILogger {
   ...
   *
   * <p>The message will be tagged with "Error" on the output so the caller does not need to put
   * such a prefix in the format string.
   *
   * <p>The output is done on {@link System#err}.
   *
   * <p>This is always displayed, independent of the logging {@link Level}.
   *
   * @param t is an optional {@link Throwable} or {@link Exception}. If non-null, it's message will
   *     be printed out.
   * @param errorFormat is an optional error format. If non-null, it will be printed using a {@link
   ...
   *
   * <p>The message will be tagged with "Warning" on the output so the caller does not need to put
   * such a prefix in the format string.
   *
   * <p>The output is done on {@link System#out}.
   *
   * <p>This is displayed only if the logging {@link Level} is {@link Level#WARNING} or higher.
   *
   ...
   * <p>The output is done on {@link System#out}.
   *
   * <p>This is displayed only if the logging {@link Level} is {@link Level#INFO} or higher.
   *
   ...
   * <p>The output is done on {@link System#out}.
   *
   * <p>This is displayed only if the logging {@link Level} is {@link Level#VERBOSE} or higher.
   *
   * @param msgFormat is a string format to be used with a {@link Formatter}. Cannot be null.
   * @param args provides the arguments for msgFormat.
   */
